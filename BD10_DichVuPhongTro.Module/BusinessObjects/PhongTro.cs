...
namespace BD10_DichVuPhongTro.Module.BusinessObjects
{
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        {
            get { return _SoPhong; }
            set { SetPropertyValue<int>(nameof(SoPhong), ref _SoPhong, value); }
        }


        private string _TinhTrang;
        [XafDisplayName("Tình Trạng"),Size(20)]
        ...
        [XafDisplayName("Loại Phòng"),Size(15)]
        public string LoaiPhong
        {
            get { return _LoaiPhong; }
            set { SetPropertyValue<string>(nameof(LoaiPhong), ref _LoaiPhong, value); }
        }
        ...
        [DevExpress.Xpo.Aggregated, Association("PT-HopDong")]
